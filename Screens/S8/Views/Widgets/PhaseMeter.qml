...
Item {
  ...
  readonly property variant deckColor:     deckId < 2 ? colors.colorDeckBlueBright : colors.colorGrey232
  ...
  Rectangle {
    ...
    color: "orange"
    radius: 2
    visible: !isMaster && !isMasterClock
  ...
  Repeater {
    ...
    Rectangle {
      ...
      height:       10
      x:            16 + index * 40
      border.color: (index == 0) ? "red" : "orange"
      border.width: 1
      radius:       2

      color: isMaster || isMasterClock || !isCurrentBeat(propSyncMasterDeck.value, index) ? "transparent"
        : (index == 0) ? "red" : "orange"
    }
  }
  ...
  Repeater {
    ...
    Rectangle {
      ...
      y:            14
      x:            16 + index * 40
      border.color: (index == 0) ? "red" : deckColor
      border.width: 1
      radius:       2

      color: !isCurrentBeat(deckId, index) ? "transparent" : (index == 0) ? "red" : deckColor
    }
  }
  ...
  Text {
    ...
    color: isApproachingNextCue(propSyncMasterDeck.value) ? "red" : "orange"
  ...
  Text {
    ...
    font.pixelSize: fonts.miniFontSize
    horizontalAlignment: Text.AlignRight
    color: isApproachingNextCue(deckId) ? "red" : deckColor
